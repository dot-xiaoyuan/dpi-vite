...
import {ProxyLog} from "../../../services/apiService.ts";
...
const ProxyRecord: React.FC = () => {
    ...
    const fetchData = async (
        ...
        const res = await ProxyLog(requestParams, collection, conditionString);
        return {
            data: res.result || [],
            success: true,
